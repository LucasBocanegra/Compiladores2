...
public class CompiladorLA {
    ...
    public static void main(String args[]) throws IOException, RecognitionException {
         ...
         ANTLRInputStream input = new ANTLRInputStream(new FileInputStream("/home/lucas/Documents/bcc/2016/2sem/CC2/Compiladores2/compiladorLA/src/compiladorLA/exemplos/lua1.txt"));
